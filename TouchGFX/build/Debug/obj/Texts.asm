; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30038.1 
	...
	TITLE	C:\TouchGFXProjects\MyApplication_13\TouchGFX\build\Debug\obj\Texts.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__E2A28DFC_Event@hpp DB 01H
__98543BD5_ClickEvent@hpp DB 01H
__A8056246_DragEvent@hpp DB 01H
__BA84CA1A_GestureEvent@hpp DB 01H
__BE92554C_Drawable@hpp DB 01H
...
__9C34C985_Atomic@hpp DB 01H
__643E1ED4_DMA@hpp DB 01H
__D8759A69_FrameBufferAllocator@hpp DB 01H
__CBFC4B21_UIEventListener@hpp DB 01H
__C737CC38_Gestures@hpp DB 01H
__F9CC1429_TextureMapTypes@hpp DB 01H
__01A212CF_DebugPrinter@hpp DB 01H
__AACFBF14_LCD@hpp DB 01H
__BB8DC7BD_MCUInstrumentation@hpp DB 01H
__C830399A_ButtonController@hpp DB 01H
__CC52CA91_TouchController@hpp DB 01H
__2CCC706A_HAL@hpp DB 01H
__BE4D598F_Texts@cpp DB 01H
__73412C64_TextProvider@hpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
...
PUBLIC	??_C@_1NC@PDNANOEN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1BC@PANDKMKI@?$AAu?$AAs?$AAe?$AAd?$AA?5?$AA?$DO?$AA?5?$AA1@ DB 'u', 00H
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1NC@PDNANOEN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1NC@PDNANOEN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	...
	DB	'_', 00H, '1', 00H, '3', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'd'
	DB	00H, 'd', 00H, 'l', 00H, 'e', 00H, 'w', 00H, 'a', 00H, 'r', 00H
	DB	'e', 00H, 's', 00H, '\', 00H, 'S', 00H, 'T', 00H, '\', 00H, 't'
	DB	00H, 'o', 00H, 'u', 00H, 'c', 00H, 'h', 00H, 'g', 00H, 'f', 00H
	DB	'x', 00H, '\', 00H, 'f', 00H, 'r', 00H, 'a', 00H, 'm', 00H, 'e'
	DB	00H, 'w', 00H, 'o', 00H, 'r', 00H, 'k', 00H, '\', 00H, 'i', 00H
	DB	'n', 00H, 'c', 00H, 'l', 00H, 'u', 00H, 'd', 00H, 'e', 00H, '\'
	DB	00H, 't', 00H, 'o', 00H, 'u', 00H, 'c', 00H, 'h', 00H, 'g', 00H
	DB	'f', 00H, 'x', 00H, '\', 00H, 'T', 00H, 'e', 00H, 'x', 00H, 't'
	DB	00H, 'P', 00H, 'r', 00H, 'o', 00H, 'v', 00H, 'i', 00H, 'd', 00H
	DB	'e', 00H, 'r', 00H, '.', 00H, 'h', 00H, 'p', 00H, 'p', 00H, 00H
	DB	00H						; `string'
CONST	ENDS
...
; File C:\TouchGFXProjects\MyApplication_13\TouchGFX\generated\texts\src\Texts.cpp
; Line 51
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET __BE4D598F_Texts@cpp
...
; File C:\TouchGFXProjects\MyApplication_13\Middlewares\ST\touchgfx\framework\include\touchgfx\TypedText.hpp
; Line 154
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __5B6BCFB8_TypedText@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 155
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_13\Middlewares\ST\touchgfx\framework\include\touchgfx\TextProvider.hpp
; Line 267
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __73412C64_TextProvider@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 268
	...
	mov	esi, esp
	push	268					; 0000010cH
	push	OFFSET ??_C@_1NC@PDNANOEN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
